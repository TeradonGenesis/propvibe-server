...
export declare type ScheduleCreateOrUpdateData = Partial<Pick<Schedule, 'name' | 'title' | 'cronExpression' | 'timezone' | 'isEnabled' | 'isExclusive' | 'description' | 'actions'>>;
...
export declare type ScheduleAction = ScheduleActionRunActor | ScheduleActionRunActorTask;
