...
export declare type ActorUpdateOptions = Partial<Pick<Actor, 'name' | 'description' | 'isPublic' | 'seoTitle' | 'seoDescription' | 'issuesEnabled' | 'title' | 'restartOnError' | 'versions' | 'categories' | 'defaultRunOptions'>>;
